...
I used familiar to me Chakra UI to move quickly while still keeping the interface polished, responsive, and consistent.
...
**Notes**
Authentication is intentionally lightweight and simulated through a cookie-based toggle in order to focus on:
